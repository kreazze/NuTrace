...
<html lang="en">
    <head>
		...
		<title>NuTrace</title>
		<link rel="stylesheet" type="text/css" href="../account-form/account.css">
    ...
    <body>
        <div class="container">
            <div class="logo">
                <img src="../assets/images/main/nutrace_logo.png" width="130px" height="130px">
            </div>
            <h1>NuTrace</h1>
            <hr class="rounded">
            <h2>Welcome!</h2>
            ...
            <a href="../admin/admin-login.php"><button class="btn3">ADMINISTRATOR</button></a><br>
        </div>
    </body>
</html> 