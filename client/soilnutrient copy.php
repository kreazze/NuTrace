...
<html lang="en">
    <head>
        ...
        <title>NuTrace</title>
        <link rel ="stylesheet" href="../client/soilnutrient copy.css">
                ...
                <li>
                    ...
                    <div class="modal-overlay" id="logout">
                        <div class="modal-wrapper"> 
                            <h2 class="q1">Are you sure you want to log out?</h2>
                            <h3 class="q2">(Sigurado ka ba na nais mong umalis dito?)</h3>
                            <div class="content">
                                <div class="buttons">
